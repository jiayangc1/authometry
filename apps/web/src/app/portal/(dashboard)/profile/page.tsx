          ...
          <div className="flex flex-col items-center justify-center bg-[var(--portal-accent-soft)] px-6 py-9 text-center">
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-0 bottom-0 flex size-9 items-center justify-center rounded-full bg-[var(--portal-ink)] text-[var(--portal-paper)] shadow-md transition-transform hover:scale-105 focus-visible:ring-2 focus-visible:ring-[var(--focus)] focus-visible:ring-offset-2 focus-visible:outline-none disabled:opacity-60 motion-reduce:transform-none motion-reduce:transition-none"
                disabled={uploading}
