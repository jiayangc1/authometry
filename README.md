...
- [MCP server](docs/mcp.md) — let an authorized AI client inspect and manage Authometry over Streamable HTTP.
...
- OAuth-scoped MCP tools for reading and managing the same resources and settings as the dashboard.
